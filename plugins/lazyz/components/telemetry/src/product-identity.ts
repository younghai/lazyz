...
export const PRODUCT_NAME = "lazyz";
export const PACKAGE_NAME = "@lazyz/plugin";
export const CACHE_DIR_NAME = "lazyz";
export const EVENT_NAME = "lazyz_daily_active";
export const LEGACY_PARENT_PACKAGE = "oh-my-opencode";
export const PRODUCT_ENV_PREFIX = "LAZYZ";
export const MACHINE_ID_PREFIX = "lazyz:";
