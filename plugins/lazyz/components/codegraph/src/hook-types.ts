...
import type { CodegraphProvisionResult as SharedCodegraphProvisionResult } from "../../../vendor/utils/src/codegraph/provision.ts";
import type {
	CodegraphCommandResolution,
	ResolveCodegraphCommandOptions,
} from "../../../vendor/utils/src/codegraph/resolve.ts";
import type { CodegraphWorkspacePreparation as SharedCodegraphWorkspacePreparation } from "../../../vendor/utils/src/codegraph/workspace.ts";
import type { CodegraphConfig as SharedCodegraphConfig } from "../../../vendor/utils/src/omo-config.ts";
