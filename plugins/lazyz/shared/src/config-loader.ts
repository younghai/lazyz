...
} from "../../vendor/utils/src/omo-config/loader.ts"
import type { OmoConfig } from "../../vendor/utils/src/omo-config.ts"
import type { OmoConfigSource } from "../../vendor/utils/src/omo-config/resolve.ts"
